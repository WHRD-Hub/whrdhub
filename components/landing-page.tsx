    ...
    <main className="min-h-screen flex flex-col bg-background">
      ...
      <section id="how-it-works" className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-3">{l.howItWorks.title}</h2>
      ...
      <section className="py-24 px-6 bg-muted/30 border-y border-border">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-3">{l.whatYouCanReport.title}</h2>
      ...
      <section className="py-24 px-6 bg-primary text-white">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-black mb-4">{l.cta.title}</h2>
      ...
      <div className="bg-red-50 border-t border-red-200 py-3 px-6">
        <div className="max-w-3xl mx-auto flex flex-wrap items-center justify-center gap-5 text-sm">
          <span className="text-red-700 font-semibold flex items-center gap-1.5">
            <Phone className="w-3.5 h-3.5" />{l.emergency.title}
          </span>
