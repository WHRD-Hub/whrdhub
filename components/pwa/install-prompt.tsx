...
export function InstallPrompt() {
  ...
  return (
    <div
      ...
      className="rounded-2xl border border-primary/20 bg-primary/5 p-4 sm:p-5 shadow-sm"
    >
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-bold text-sm text-foreground">Install WHRD Hub</p>
          ...
          {showIosHelp ? (
            <div className="mt-3 rounded-xl bg-white border border-border p-3 text-xs text-muted-foreground space-y-1.5">
              ...
              <p className="flex items-center gap-1.5">
                2. Choose <span className="font-medium text-foreground">Add to Home Screen</span>
                <Plus className="w-3.5 h-3.5 inline" />.
              </p>
              <p>3. Tap <span className="font-medium text-foreground">Add</span>.</p>
            </div>
          ) : (
