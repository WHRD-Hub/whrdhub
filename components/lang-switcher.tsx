    ...
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-full mt-1.5 z-[200] min-w-[180px] bg-white border border-border rounded-xl shadow-lg overflow-hidden"
        >
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-left transition-colors
                  ${isSelected ? "bg-primary/5 text-primary font-semibold" : "text-foreground hover:bg-muted/40"}`}
              >
