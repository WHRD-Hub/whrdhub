                ...
                <TableCell>
                  <div className="flex flex-wrap gap-1">
                    {(r.incident_types as string[]).slice(0, 2).map(t => (
                      <span key={t} className="text-xs bg-muted px-1.5 py-0.5 rounded text-muted-foreground">{t.replace(/_/g, " ")}</span>
                    ))}
...
async function AdminReportsContent({ searchParams }: { searchParams: Promise<Record<string, string>> }) {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {/* Filters */}
      <form method="GET" className="bg-white rounded-xl border border-border p-4 flex flex-wrap gap-3 items-end">
        <div>
          <label className="block text-xs font-semibold mb-1 text-muted-foreground">County</label>
          <select name="county" defaultValue={county || ""} className="rounded-lg border border-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring">
        ...
        <div>
          ...
          <select name="urgency" defaultValue={urgency || ""} className="rounded-lg border border-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring">
        ...
        <div>
          <label className="block text-xs font-semibold mb-1 text-muted-foreground">Fact-Check Status</label>
          <select name="verif" defaultValue={verif || ""} className="rounded-lg border border-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring">
            <option value="">All</option>
        ...
        <div>
          <label className="block text-xs font-semibold mb-1 text-muted-foreground">Reporter Type</label>
          <select name="reporter" defaultValue={reporter || ""} className="rounded-lg border border-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring">
            <option value="">All</option>
